 ...
 */
require(['jquery', 'd3', './listeners', './listview', './setlist', './overviewgraph', './setinfo', './datastore', './pathstatsview', 'font-awesome'],
  function ($, d3, listeners, listView, setList, overviewGraph, setInfo, dataStore, pathStatsView) {
    'use strict';
