define(["jquery", "d3", "./settings", "../../listeners", "../../uiutil", "../pathsorting", "../../datastore", "../../config", "../../setinfo", "../../sorting", "../../selectionutil", "require", "./pathdata"],
  function ($, d3, s, listeners, uiUtil, pathSorting, dataStore, config, setInfo, sorting, selectionUtil, require, pathData) {
