 ...
 */
define(['d3', 'phovea_core/src'], function (d3, C) {
  ...
  return {
    ...
    addDefaultTrigger: function (selection, idAccessor, idType, source) {
      var that = this;
      selection
    ...
    addDefaultListener: function (parent, selector, idAccessor, idType, source) {
      ...
      this.addDefaultTrigger(parent.selectAll(selector), idAccessor, idType, source);
